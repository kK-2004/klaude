...
export function SettingsPage() {
  const {
    ...
    contextLimit, setContextLimit, turnLimit, setTurnLimit, setPage,
  } = useApp()
  ...
  return (
    <div className="page-plain settings-page">
      <header className="page-heading">
        <h1>设置</h1>
        <p>外观、模型和工作区限制。凭据只通过环境变量引用，不会以明文保存。</p>
      </header>
      ...
      <button type="button" className="primary-save" onClick={() => setPage('home')}>
        <Check size={15} strokeWidth={2} /> 完成
      </button>
    </div>
  )
}
